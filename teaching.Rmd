...
If you are here for the **Spring 2026** course materials of **Ordinary Differential Equation** or **Applied Statistics I**, then visit following **course websites**.

```{r, echo=FALSE}
icon_link(
    text = "Ordinary Differential Equations",
    url  = "https://upmathematics.github.io/mth-321ab-sp26/"
)
icon_link(
    text = "Applied Statistics",
    url  = "https://upmathematics.github.io/mth-361a-sp26/"
)
```
:::
:::
...
*These are subjects I taught as instructor.*
  ...
  - **MTH-321 (Ordinary Differential Equations)**
    ...
    *Semesters Taught:* Fall 2023, Spring 2024, Fall 2024, Fall 2025, Spring 2026
