...
If you are here for the **Fall 2025** course materials of **Ordinary Differential Equation** or **Introduction to Linear Algebra**, then visit following **course websites**.

```{r, echo=FALSE}
icon_link(
    text = "Ordinary Differential Equation",
    url  = "https://upmathematics.github.io/mth-321ab-fa25/"
)
icon_link(
    text = "Introduction to Linear Algebra",
    url  = "https://upmathematics.github.io/mth-341a-fa25/"
)
```
:::
:::
...
*These are subjects I taught as instructor.*
  ...
  - **MTH-321 (Ordinary Differential Equations)**
    ...
    *Semesters Taught:* Fall 2023, Spring 2024, Fall 2024, Spring 2025
