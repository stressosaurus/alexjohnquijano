...
If you are here for the **Spring 2025** course materials of **Elementary Statistics**, **Applied Statistics**, or **Fundamentals of Data Science**, then visit following **course websites**.

```{r, echo=FALSE}
icon_link(
    text = "Elementary Statistics",
    url  = "https://upmathematics.github.io/mth-161d-sp25/"
)
icon_link(
    text = "Applied Statistics",
    url  = "https://upmathematics.github.io/mth-361a-sp25/"
)
icon_link(
    text = "Fundamentals of Data Science",
    url  = "https://upmathematics.github.io/mth-391a-sp25-otco/"
)
```
:::
:::
