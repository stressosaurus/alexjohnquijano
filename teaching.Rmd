...
If you are here for the **Fall 2026** course materials of **Ordinary Differential Equation** or **Probability and Statistics I**, the links below directs you to each course's Canvas page.

```{r, echo=FALSE}
icon_link(
    text = "Ordinary Differential Equations",
    url  = "https://portland.instructure.com/courses/2789"
)
icon_link(
    text = "Probability and Statistics I",
    url  = "https://portland.instructure.com/courses/1651"
)
```
:::
:::
...
* Ordinary Differential Equations
  ...
  - [Horizontal Spring-Mass Simulator](learning-tools/horizontal_spring_mass_simulator.html){target="_blank"}
  - [1st-Order ODE Visualizer](learning-tools/1st-order-ode-visualizer.html){target="_blank"}
  - [Phase Portrait Visualizer for 1st-Order Homogeneous Linear System](https://pcnkto-alex0john-quijano.shinyapps.io/ode-visualize/){target="_blank"}

* Probability and Statistics

  - [Monty Hall Simulator](learning-tools/monty_hall_retro.html){target="_blank"}
  - [Monty Hall Simulator (Four-Door Variant)](learning-tools/monty_hall_4doors_retro.html){target="_blank"}
...
*These are subjects I taught as instructor.*
  ...
  - **MTH-321 (Ordinary Differential Equations)**
    ...
    *Semesters Taught:* Fall 2023, Spring 2024, Fall 2024, Fall 2025, Spring 2026, Fall 2026
  ...
  - **MTH-361 (Applied Statistics)**
    ...
    *Semesters Taught:* Spring 2023, Spring 2025, Spring 2026
  ...
  - **MTH-461 (Probability and Statistics I)**
    ...
    *Semesters Taught:* Fall 2022, Fall 2024, Fall 2026
